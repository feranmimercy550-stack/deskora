      ...
      <div className="bg-card p-8 rounded-2xl shadow-md w-full max-w-md border border-border">
        ...
        <form onSubmit={handleRegister} className="space-y-4">
          ...
          <div className="grid grid-cols-2 gap-3">
            <button type="button" className="flex items-center justify-center gap-2 border border-input rounded-lg py-2.5 text-sm font-medium hover:bg-accent transition">
